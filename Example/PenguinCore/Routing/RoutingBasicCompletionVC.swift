//
//  RoutingBasicCompletionVC.swift
//  PenguinCore_Example
//
...
internal final class RoutingBasicCompletionVC: UIViewController, PenguinCoordinatorVCProtocol {
    ...
    @objc private func successTapped() {
        coordinator?.completion?(.success(Data()))
    }
...
extension RoutingBasicCompletionVC {
    private func setupUI() {
        view.backgroundColor = .white
        
        navigationItem.backButtonTitle = ""
        title = "Basic Completion Routing"

...
internal final class CustomRoutingBoolVC: UIViewController, PenguinCoordinatorVCProtocol {
    ...
    @objc private func successTapped() {
        coordinator?.completion?(.success((Int.random(in: 0...1) == 1).toData()))
    }
...
extension CustomRoutingBoolVC {
    private func setupUI() {
        view.backgroundColor = .white
        
        navigationItem.backButtonTitle = ""
        title = "Bool Completion Routing"

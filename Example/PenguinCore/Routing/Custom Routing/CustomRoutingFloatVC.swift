...
internal final class CustomRoutingFloatVC: UIViewController, PenguinCoordinatorVCProtocol {
    ...
    @objc private func successTapped() {
        coordinator?.completion?(.success(Float.random(in: (0.0)...(10.0)).toData()))
    }
...
extension CustomRoutingFloatVC {
    private func setupUI() {
        view.backgroundColor = .white
        
        navigationItem.backButtonTitle = ""
        title = "Float Completion Routing"

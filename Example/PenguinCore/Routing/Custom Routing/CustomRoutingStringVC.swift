...
internal final class CustomRoutingStringVC: UIViewController, PenguinCoordinatorVCProtocol {
    ...
    @objc private func successTapped() {
        coordinator?.completion?(.success("Ade Resie".toData()))
    }
...
extension CustomRoutingStringVC {
    private func setupUI() {
        view.backgroundColor = .white
        
        navigationItem.backButtonTitle = ""
        title = "String Completion Routing"

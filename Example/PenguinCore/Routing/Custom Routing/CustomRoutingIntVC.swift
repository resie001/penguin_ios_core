...
internal final class CustomRoutingIntVC: UIViewController, PenguinCoordinatorVCProtocol {
    ...
    @objc private func successTapped() {
        coordinator?.completion?(.success(Int.random(in: 0...10).toData()))
    }
...
extension CustomRoutingIntVC {
    private func setupUI() {
        view.backgroundColor = .white
        
        navigationItem.backButtonTitle = ""
        title = "Int Completion Routing"
